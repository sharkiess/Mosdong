...
namespace Mosdong.Data.Migrations
{
    ...
    [Migration("20200714143832_AddOrderHeaderAndDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mosdong.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mosdong.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mosdong.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mosdong.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mosdong.Models.ProductItemModel", b =>
                {
                    ...
                    b.Property<int>("StockAvailabilityNum")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mosdong.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mosdong.Models.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mosdong.Models.OrderDetails", b =>
                {
                    b.HasOne("Mosdong.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mosdong.Models.ProductItemModel", "ProductItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Mosdong.Models.OrderHeader", b =>
                {
                    b.HasOne("Mosdong.Models.ViewModels.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
